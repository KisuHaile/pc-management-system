...
<html lang="en">
  <head>
    ...
    <title>DBU PC controll system</title>
...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Permissions Dashboard</h1>
                ...
                <table id="datatablesSimple" class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Manage Users</td>
                            <td>Can create, edit, delete system users.</td>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Register PC</td>
                            <td>Allows user to register new PCs.</td>
                            <td><span class="badge bg-success">Active</span></td>
                            <td>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-info btn-sm"><i class="fas fa-eye"></i> View</button>
                        ...
                        <tr>
                            <td>3</td>
                            <td>View Logs</td>
                            <td>Can view user activity logs.</td>
